<?php
// Plantilla
$link_token = BASE_PATH.$urlTree['verificar-email'].'/?token='.$token.'&e='.$hotelierEmail.'&tp=h&guid='.$guidHotel;

$asunto = $asun;
$cuerpo = '<h2>'.$txt1.' '.$hotelierName.',</h2>
'.$txt2.' <strong>'.$hotelNameReg.'</strong>
<br><br>
'.$txt3.'.
<br><br>
<a href="'.$link_token.'" title="'.$txt4.'">
...
<br>'.$linkBelow.'<br>
<br><a href="'.$link_token.'">'.$link_token.'</a>
<br><br>
'.$txt5;
?>