...
$msg4036 = "'To' date should be later than 'From' date"; //Fecha inicio superior fecha fin
...
$msg4043 = "Invalid email, please use a real one";
...
$msg4064 = 'An unexpected error occurred while you tried to login. Please, try again.';
...
//Error Curl Unifi
$msg4071 = "Access to WiFi not available at this time";
$msg4072 = "Please, try again or contact with reception if the problem persists";
//ERROR PMS VALIDATOR
$msg4073 = 'The data entered do not coincide with our records. If you are a guest, please try later or contact reception.';
...
$msg4082 = 'You cannot activate the page since some translations are missing';
...
$msg4090 = "The email obtained from the system is not valid, please use another one";
...
$msg4096 = "Request successfully processed. Depending on the file size, this process may take a while. If you do not receive the email, please make sure that your mail server accepts large files.";
...
$msg4099 = "Some of the form fields are incorrect. Please check it.";
$msg4100 = "Please, indicate a valid room number";