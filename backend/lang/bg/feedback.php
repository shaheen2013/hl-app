...
$msg4043 = "Невалиден имейл адрес. Моля, използвайте действителен имейл адрес.";
...
$msg4064 = 'Възникна неочаквана грешка при опит за влизане в системата. Моля, опитайте отново.';
...
//Error Curl Unifi
$msg4071 = "В момента достъпът до WiFi не може да се осъществи.";
$msg4072 = "Please, try again or contact with reception if the problem persists";
//ERROR PMS VALIDATOR
$msg4073 = 'Въведените данни не съвпадат със записаните в нашата система. Ако сте наш клиент, моля, опитайте отново по-късно или се свържете с рецепцията.';
...
$msg4090 = "Полученият от системата имейл адрес е невалиден. Моля, използвайте друг.";
...
$msg4099 = "Някои полета във формуляра са грешни. Моля, проверете ги.";
$msg4100 = "Моля, посочете валиден номер на стая.";