...
$msg2004 = 'Alerta! ha cambiado la posición del widget, esto requerira que actualice el tag en su página web';
...
$msg4076 = "La cuenta a la que intenta conectarse se encuenta desactivada";
...
$msg4043 = "Email no válido, por favor utiliza un email real";
...
$msg4064 = 'Ha ocurrido un error inesperado cuando intentabas loguearte. Por favor, inténtalo de nuevo.';
//Error de base de datos
$msg4065 = "Error al insertar datos, por favor contacta con soporte si persiste el problema";
...
//Error Curl Unifi
$msg4071 = "Acceso a la WiFi no disponible en este momento";
$msg4072 = "Por favor, inténtelo de nuevo o contacte con recepción si el problema persiste";
$msg4073 = 'Los datos introducidos no coinciden con nuestros registros, si es usted cliente inténtelo más tarde o póngase en contacto con recepción';
$msg4074 = "Todos los campos son requeridos";

// Errors Eprivacy page
$msg4082 = 'No puedes activar la página porque hay idiomas sin traducir';

//GTM Errors
$msg4075 = "No se han podido recuperar las variables del Google Tag Manager. Por favor, asegurate que el container_id y workspace_id son correctos";
...
$msg4090 = "El correo electrónico obtenido del sistema no es válido, por favor utilice otro";
...
$msg4099 = "Alguno de los campos del formulario son incorrectos. Por favor, revísalo.";
$msg4100 = "Por favor indique un número de habitación valido";
