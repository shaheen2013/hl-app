<?php
	$lang = [
        ...
        "title no booking engine integrated alert" => "Tu motor de reserva no está integrado con Hotelinking.",
        "no booking engine integrated alert" => "Para integrar tu motor de reservas y empezar a ver tus estadísticas, por favor contacta con tu <a href='mailto:helpdesk@hotelinking.com'>key account</a>."
    ];
