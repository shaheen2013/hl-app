<?php
	$lang = [
            ...
            "title no booking engine integrated alert" => "No té connectat el seu motor de reserves amb Hotelinking",
            "no booking engine integrated alert" => "Per a connectar el seu motor de reserves i començar a veure estadístiques, per favor, parli amb el seu <a href='mailto:helpdesk@hotelinking.com'>key account</a>.",
    ];
