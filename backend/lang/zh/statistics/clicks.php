<?php
	$lang = [
            ...
            "title no booking engine integrated alert" => "Il suo motore di prenotazione non è collegato all'Hotelinking",
            "no booking engine integrated alert" => "Per collegare il suo motore di prenotazione ed iniziare a vedere statistiche, la preghiamo di contattare il suo <a href='mailto:helpdesk@hotelinking.com'>key account</a>.",
    ];
