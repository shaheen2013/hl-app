<div class="bookingShare booking-share-2">
  ...
  <div class="section text-center">
    ...
    if($shareScreen === true){ ?>
      ...
      <div class="shareButtons mt2">
        <button class="btn  instructionBtn btn-blanco btn-lg"><i class="fa fa-facebook-official pr"></i><?php echo ($ofertaShare == true ? $hotelBookingShareLang['Get your voucher for free now'] : $hotelBookingShareLang['Share on Facebook now']) ?></button>
      </div>
