...
if(!defined('INDEXCONTROLVAL')){echo 'No direct access allowed.';exit;} ?>
	...
	<div class="container">
		...
		<div class="col-lg-8 ofertaDetalle col-md-7">
			...
			<div class="white-module hotelAmenities mt">
			...
			<div class="white-module hotelConditions mt">
				<h3><?php echo $HotelLang['Hotel conditions'] ?></h3>
				<p>
					<?php echo $arrayDatosHotel['condiciones'] ?>
				</p>
			</div>
			<div class="white-module mt mb hotelUserComments">
				<div class="row">
					<div class="col-lg-12">
						<h3><?php echo $HotelLang['Guests comment and ratings'] ?></h3>
						<div id="results">
		...
		<div class="col-lg-4 col-md-5">
			<div class="btn-group-vertical dblock hotelOptions text-left">
			<a href="<?php echo $urlTree['tienda'] ?>/?hot=<?php echo $arrayDatosHotel['id'] ?>" class="btn btn-success btn-lg"><i class="fa fa-shopping-cart pr"></i> <strong><?php echo $HotelLang['Go to rewards shop'] ?></strong></a>
				<a href="#" class="btn btn-default btn-lg hotelBookingBtn"><i class="fa fa-book pr"></i><?php echo $HotelLang['Booking contact info'] ?></a>
						<?php if(!empty ($follow)) {
							if($follow){ ?>
							<a href="/hotel/<?php echo $arrayDatosHotel['hotelName_san'] ?>/<?php echo $arrayDatosHotel['id'] ?>/?unfol=<?php echo $arrayDatosHotel['id'] ?>" class="btn btn-default btn-lg"><i class="fa fa-thumbs-o-down pr"></i> <?php echo $HotelLang['Unfollow hotel'] ?></a>
							<?php }else{ ?>
							<a href="/hotel/<?php echo $arrayDatosHotel['hotelName_san'] ?>/<?php echo $arrayDatosHotel['id'] ?>/?fol=<?php echo $arrayDatosHotel['id'] ?>" class="btn btn-default btn-lg"><i class="fa fa-thumbs-o-up pr"></i> <?php echo $HotelLang['Follow hotel'] ?></a>
							<?php } ?>
							<?php }else{ ?>
							<a href="/hotel/<?php echo $arrayDatosHotel['hotelName_san'] ?>/<?php echo $arrayDatosHotel['id'] ?>/?fol=<?php echo $arrayDatosHotel['id'] ?>" class="btn btn-default btn-lg"><i class="fa fa-thumbs-o-up pr"></i> <?php echo $HotelLang['Follow hotel2'] ?></a>
							<?php } ?>
				<a href="#" class="btn btn-default btn-lg hotelIssueBtn"><i class="fa fa-exclamation-triangle pr"></i> <?php echo $HotelLang['Help'] ?></a>
			</div>
			<div class="white-module mt overflowHidden">
				<div class="col-lg-4 text-center">
					<h4><i class="fa fa-heart mb fa-2x"></i><br><?php echo $HotelLang['Rating'] ?></h4>
					<h4><strong><?php echo $arrayDatosHotel['rating'] ?></strong></h4>
				</div>
				<div class="col-lg-4 text-center">
					<h4><i class="fa fa-comments-o mb fa-2x"></i><br><?php echo $HotelLang['Guests review'] ?></h4>
					<h4><strong><?php echo $comments ?></strong></h4>
				</div>
				<div class="col-lg-4 text-center">
					<h4><i class="fa fa-gift mb fa-2x"></i><br><?php echo $HotelLang['Reward offers'] ?></h4>
					<h4><strong><?php echo $rewards ?></strong></h4>
				</div>
			</div>
			<div class="white-module mt overflowHidden text-center priceRangeModule">
			...
			<h4 class="mt2"><?php echo $HotelLang['Most relevant rewards'] ?></h4>
			<?php foreach ($arrayRewards as $reward) { ?>
				<div class="white-module mt sidebarOffer">
						<h4 class="offer-rubies"><?php echo($reward['adq_ret'] == 'adq' ? '<i class="rubies rubix2 rubiesHL">rubies</i>' : '<i class="rubies rubix2">rubies</i>' ) ?> <?php echo $reward['puntos']?></h4>
						<div class="fichaHotelOfferFooter">
							<h4><strong><?php echo $reward['nombre']?></strong></h4>
						</div>
						<a href="<?php echo $urlTree['oferta'] ?>/<?php echo $reward['nombre_san']?>/<?php echo $reward['id']?>"><img src="<?php echo DIR_IMG_OFERTAS . $reward['id'] .'/med_'. $reward['img'] ?>"></a>
				</div>
			<?php } ?>
		</div>
	</div>
