                        ...
                        <form method="POST">
                            <div class="panel panel-default noPadding">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <?php if ($permisosHotel) {
                                            ?>
                                            <div class="col-lg-9">

                                                <div class="form-group">
                                                    <label for="companyName"><?php echo $lang['Company name'] ?></label>
                                                    <input type="text" class="form-control input_eprivacy" name="company_name"                                                   
                                                           id="companyName"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input_eprivacy" name="company_address" 
                                                           id="companyAddress"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control input_eprivacy" name="company_nif" 
                                                                   id="companyNIF"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" 
                                                                    class="form-control input_eprivacy"
                                                                   name="company_email"
                                                                   id="companyEmail"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group col-lg-12">
                                                    ...
                                                    <select class="form-control" id="restricted_portal"
                                                        ...
                                                        <?php if (!array_get($brand_eprivacy_info, 'not_hotel')) { ?>
                                                            <option value="restrictive" <?php echo (array_get($brand_eprivacy_info, 'restricted_portal') && !array_get($brand_eprivacy_info, 'not_hotel')) ? 'selected' : '' ?>><?php echo $lang['Restrictive'] ?></option>
                                                            <option value="classic" <?php echo (!array_get($brand_eprivacy_info, 'restricted_portal') && !array_get($brand_eprivacy_info, 'not_hotel')) ? 'selected' : '' ?>><?php echo $lang['Classic'] ?></option>
                                                        <?php } ?>
                                                        <?php if (array_get($brand_eprivacy_info, 'not_hotel')) { ?>
                                                            <option value="restrictive_not_hotel" <?php echo array_get($brand_eprivacy_info, 'not_hotel') ? 'selected' : '' ?>><?php echo $lang['No hotel'] ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group col-lg-12">
                                                        <label class="col-lg-12"
                                                            ...
                                                            : </label>
                                                        <select class="form-control" id="choose_ep_text"
                                                                name="choose_ep_text"
                                                                onchange="enableEprivacyInputs()"
                                                                >
                                                            <option value="default" <?php echo array_get($second_eprivacy_page_module_content, 'configuration') == 'default' ? 'selected' : '' ?>><?php echo $lang['Use default configuration'] ?></option>
                                                            <option value="custom_content" <?php echo array_get($second_eprivacy_page_module_content, 'configuration') == 'custom_content' ? 'selected' : '' ?>><?php echo $lang['Set your Eprivacy legal text'] ?></option>
                                                            <option value="own_vars" <?php echo array_get($second_eprivacy_page_module_content, 'configuration') == 'own_vars' ? 'selected' : '' ?>><?php echo $lang['Set your Info'] ?></option>
                                                        </select>
                                    ...
                                    <?php if ($permisosHotel) {
                                        ...
                                        <div class="row" style="min-height: 39rem;">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li><a data-toggle="tab"
                                                       href="#legal_text"><?php echo $lang['Legal text'] ?></a></li>
                                            ...
                                            <div class="tab-content">
                                                <div class="col-lg-12 tab-pane fade in default-tab"
                                                    ...
                                                    <label class="pull-right" style="margin-top: 30px;"><input
                                                                type="checkbox"
                                                                name="eprivacy_text"
                                                                class="" <?php echo array_get($first_eprivacy_page_module_content, 'active') ? 'checked' : '' ?>> <?php echo $lang['Active'] ?>
                                                    </label>
                                                    <div>
                                                        <ul class="nav nav-tabs">
                                                ...
                                                <div class="col-lg-12  tab-pane fade in" style="max-width: 830px;"
                                                    ...
                                                    <label style="margin-top: 30px;"> <?php echo "CLIENT" ?></label>
                                                    <label class="pull-right" style="margin-top: 30px;"><input
                                                                type="checkbox"
                                                                name="second_eprivacy_text"
                                                                class="" <?php echo array_get($second_eprivacy_page_module_content, 'active') ? 'checked' : '' ?>> <?php echo $lang['Active'] ?>
                                                    </label>
                                                    <div>
                                                        <ul class="nav nav-tabs">
                                                            <?php foreach ($langs as $language) {
...
<?php if(!$restrictive) { ?>
                                                    ...
                                                    <label class="pull-right" style="margin-top: 30px;"><input
                                                                ...
                                                                class="" <?php echo array_get($second_eprivacy_page_restrictive_module_content, 'active') ? 'checked' : '' ?>> <?php echo $lang['Active'] ?>
                                                    </label>
                                                    <div>
                                                        <ul class="nav nav-tabs">
                                                            <?php foreach ($langs as $language) {
                                                ...
                                                <div class="col-lg-12 tab-pane fade in" style="max-width: 830px;"
                                                    ...
                                                    <label class="pull-right" style="margin-top: 30px;"><input
                                                                type="checkbox"
                                                                name="legal_text"
                                                                class="" <?php echo array_get($legal_text_page_module_content, 'active') ? 'checked' : '' ?>> <?php echo $lang['Active'] ?>
                                                    </label>
                                                    <div>
                                                        <ul class="nav nav-tabs">
                                                            <?php foreach ($langs as $language) {
...
<?php if ($permisosHotel) {
    ...
    <script>
        ...
        privacyPolicyEditor1_<?php echo array_get($lang, 'name') ?>.value = "<?php echo preg_replace('#<script(.*?)>(.*?)</script>#is', '', array_get($first_eprivacy_page_module_content, array_get($lang, 'name')) ?? '') ?>";
        <?php
        } ?>
        ...
        privacyPolicyEditor2_<?php echo array_get($lang, 'name') ?>.value = "<?php echo preg_replace('#<script(.*?)>(.*?)</script>#is', '', array_get($second_eprivacy_page_module_content, array_get($lang, 'name')) ?? '') ?>";
        ...
        privacyPolicyEditor2_<?php echo array_get($lang, 'name') ?>.value = "<?php echo preg_replace('#<script(.*?)>(.*?)</script>#is', '', array_get($second_eprivacy_page_restrictive_module_content, array_get($lang, 'name')) ?? '') ?>";
        ...
        privacyPolicyEditor3_<?php echo array_get($lang, 'name') ?>.value = "<?php echo preg_replace('#<script(.*?)>(.*?)</script>#is', '', array_get($legal_text_page_module_content, array_get($lang, 'name')) ?? '') ?>";
        ...
        var selectedValue = $('#choose_ep_text').val();

        function enableEprivacyInputs() {
            
            selectedValue = $('#choose_ep_text').val();
            
            if (selectedValue == 'default') {
                $('.input_eprivacy').attr('disabled', true);
                $('#companyName').attr('required', false);
            } else {
                $('.input_eprivacy').attr('disabled', false);
                $('#companyName').attr('required', true);
            }
        }
        
        enableEprivacyInputs();
