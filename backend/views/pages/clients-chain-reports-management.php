...
<?php include LANG . $_SESSION['userLang'] . '/clients-chain-reports-management.php' ?>
<div id="wrapper">
                        ...
                        <table class="table table-striped table-bordered mb0" id="goals-div">
                            ...
                            ?>
                                    <tr>
                                        <td>
                                            <div class='col-lg-12'>
                                                <div>
                                                    <input type='number' min="1" name='frequency' class='goal form-control frequency' value='<?php echo array_get($hotelAutomaticReport, 'frequency') ?>' placeholder='<?php echo $lang['frequency'] ?>'>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <select class='goal-select form-control report_type' name="report_type">
                                                    ...
                                                    <option <?php echo array_get($hotelAutomaticReport, 'report_type') == 'segment' ? 'selected' : '' ?> value="segment"><?php echo ucfirst($lang['segment']) ?></option>
                                                </select>
                                            </div>
                                        </td>
                                        <td>
                            ...
                            <tr>
                                <td>
                                    <div class='col-lg-12'>
                                        <div>
                                            <input type='number' min="1" name='frequency' class='goal form-control frequency' value='' placeholder='<?php echo $lang['frequency'] ?>'>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <select class='goal-select form-control report_type' name="report_type">
                                            ...
                                            <option value="segment"><?php echo ucfirst($lang['segment']) ?></option>
...
<script>
    ...
    function saveGoal(element) {
        ...
        $.ajax({
            url: "/lib/webservices/clients-reports-management-ws.php",
            data: "&action=save&hotel_id=<?php echo $hotelId ?>&automatic_report_id=" + automatic_report_id + "&emails=" + emails + "&chain_id=<?php echo $chainId ?>&report_type=" + report_type + "&frequency=" + frequency,
            type: 'POST',
            success: function(output) {
                if (output !== 'error') {
    ...
    <?php if ($portalProActivated): ?>
        function savePortalProReport(element) {
            ...
            var brandId = <?php echo $chainBrandId ?>;
            ...
            $.ajax({
                url: "/lib/webservices/clients-reports-management-ws.php",
                data: "&action=portal_pro_save&method=" + method + "&brandId=" + brandId + "&emails=" + emails + "&interval=" + frequency + "&productId=" + productId,
                type: 'POST',
                success: function(output) {
                    if (output !== 'error') {
