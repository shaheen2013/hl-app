...
<head>
	<title><?php echo $Thtitle;?></title>
	<meta charset="UTF-8">
	<meta name="description" content="<?php echo $Thdescription;?>">
...
<body>
	...
	<section class="wrapper">
		<h1><?php echo $Th1; ?></h1>
		<h2 class="mb20"><?php echo $Th2; ?></h2>
		<div class="whats-next">
			<h3><?php echo $Th3; ?></h3>
			<p><?php echo $Thp; ?></p>
			<h3><?php echo $Th32; ?></h3>
			       <div class="tweet-btn">
			  		<a class="btn-lg btn" href="https://twitter.com/intent/tweet?url=<?php echo $url_twitter;?>&text=<?php echo $texto;?>&via=<?php echo $via;?>"  target="_blank" height="200", width="400" ><?php echo $Thtweet; ?></a>
			       </div>
			<p><?php echo $Thp2; ?></p>
